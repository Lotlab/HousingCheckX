...
namespace HousingCheck
{
    public class Config
    {
        ...
        /// 国服 Opcode
        /// </summary>
        public const int OPCODE_WARD_INFO = 567;
        public const int OPCODE_LAND_INFO = 762;
        public const int OPCODE_SALE_INFO = 138;
        public const int OPCODE_CLIENT_TRIGGER = 559;
